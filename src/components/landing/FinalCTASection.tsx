  ...
  return (
    <section className="section-padding-lg bg-primary text-secondary">
      <div className="eden-container text-center">
        ...
        <p className="font-body text-lg text-primary-foreground/70 max-w-2xl mx-auto mb-12">Your body pattern, your terrain, your design — they are not accidents. Begin the journey of understanding the body you were given and the plants that were placed for its care.
