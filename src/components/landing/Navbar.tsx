  ...
  return (
    <header className="w-full bg-[#FAF8F3] border-b border-[#D6CDB8] sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden min-[920px]:flex items-center gap-6">
        ...
        <button
          className="min-[920px]:hidden text-[#3B4A3F] min-h-[44px] min-w-[44px] flex items-center justify-center"
      ...
      {open && (
        <div className="min-[920px]:hidden bg-[#FAF8F3] border-t border-[#D6CDB8] px-6 pb-6 pt-4 flex flex-col gap-5">
