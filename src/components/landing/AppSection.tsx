...
const tiers = [
  {
    ...
    description:
      "Begin your body pattern journey. Introductory assessment, basic herb profiles, and foundational educational content.",
    price: "Free",
    fullPrice: null,
    betaPrice: null,
    betaNote: null,
      ...
      <div className="eden-container">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="font-accent text-lg md:text-xl text-muted-foreground italic mb-4">
            Body Pattern Intelligence for Modern Herbalists.
          </p>
