...
const tiers = [
  { tier: "Tier 1", title: "Biblical Framework and Foundations", desc: "Learn the theological and scientific basis for constitutional herbalism. Understand the six tissue states, the Five Tenets of Health, and how to begin reading your body's patterns. Enrolling now, $97." },
        ...
        <div className="eden-container max-w-3xl mx-auto px-6">
          ...
          <ScrollReveal delay={100}>
            <div className="space-y-6 text-base md:text-lg leading-relaxed" style={{ color: "hsl(var(--eden-bark) / 0.75)", fontFamily: "'EB Garamond', 'Crimson Text', Georgia, serif" }}>
              ...
              <p>Constitutional herbalism is the practice of matching herbs to the person — not the symptom. It's built on a simple but profound truth: God didn't design every body the same way. Your body has a pattern — and when you understand that pattern, you stop guessing and start healing.</p>
        ...
        <div className="eden-container max-w-3xl mx-auto px-6">
          ...
          <ScrollReveal delay={100}>
            <div className="space-y-6 text-base md:text-lg leading-relaxed" style={{ color: "hsl(var(--eden-bark) / 0.75)", fontFamily: "'EB Garamond', 'Crimson Text', Georgia, serif" }}>
              ...
              <p>A person with a hot, tense body pattern who can't sleep needs a very different herb than a person with a cold, relaxed body pattern who can't sleep. Giving them both valerian isn't herbalism — it's guessing.</p>
              <p>When you match the herb to the body pattern, the results aren't subtle. They're profound. Because you're not suppressing a symptom. You're restoring the terrain.</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="eden-container max-w-3xl mx-auto relative z-10 px-6 text-center">
          ...
          <ScrollReveal delay={100}>
            <div className="space-y-6 text-base md:text-lg leading-relaxed mb-10" style={{ color: "rgba(245, 240, 232, 0.8)", fontFamily: "'EB Garamond', 'Crimson Text', Georgia, serif" }}>
              ...
              <p>The Eden Institute offers a free Body Pattern Quiz that assesses your unique pattern across the six tissue states. In just a few minutes, you'll discover whether you tend toward hot or cold, damp or dry, tense or relaxed — and you'll begin to understand why certain herbs have worked for you in the past while others haven't.</p>
              <p>This is the starting point. Once you know your body pattern, everything changes — from the herbs you choose to the foods you eat to the way you approach your family's health.</p>
            </div>
          </ScrollReveal>
          <ScrollReveal delay={200}>
            <JourneyAwareQuizCTA
