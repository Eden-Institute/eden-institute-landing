...
const Results = () => {
  ...
  useEffect(() => {
    ...
    const description = `You are ${profile.nickname} (${constitutionType}). ${profile.tagline} Discover your top herbs and a Biblical framework for your body pattern.`;
