    ...
    <main className="min-h-screen overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur border-b border-border">
        <div className="eden-container flex items-center justify-between py-3 px-6">
          <Link to="/" className="font-serif text-lg font-bold text-foreground tracking-wide">
            The Eden Institute
          </Link>
          <div className="flex items-center gap-6">
            <Link to="/" className="font-body text-sm text-foreground/80 hover:text-foreground transition-colors hidden sm:inline">
              Home
            </Link>
            <Link to="/why-eden" className="font-body text-sm text-foreground/80 hover:text-foreground transition-colors hidden sm:inline">
              Why Eden
            </Link>
            <button
              onClick={openQuiz}
      ...
      <section id="hero" className="pt-32 pb-20 md:pt-40 md:pb-28 parchment-texture relative overflow-hidden">
        ...
        <div className="eden-container text-center px-6 relative z-10">
          ...
          <p className="font-body text-xl sm:text-2xl md:text-3xl text-foreground/80 mb-10 font-medium">
      ...
      <section id="course" className="section-padding-lg parchment-texture">
        <div className="eden-container px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            {/* Tier 1 */}
            <div
              className="rounded-lg p-6 md:p-8 border flex flex-col"
              style={{
      ...
      {/* ─── SECTION 4: THE APP ─── */}
      <section className="section-padding-lg" style={{ backgroundColor: "hsl(var(--eden-sage))" }}>
        <div className="eden-container text-center px-6">
          ...
          <p className="font-body text-base sm:text-lg max-w-3xl mx-auto leading-relaxed mb-8" style={{ color: "hsl(var(--eden-parchment)/0.9)" }}>
