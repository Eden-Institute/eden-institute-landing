...
import heroHomeschool from "@/assets/hero-homeschool.jpg";
...
const Homeschool = () => {
  ...
  const openReserveFounders = () => openWaitlist({
    ...
    subtitle: "Preorders are open now. The first 500 kits sell at the $249 Founders price before the $349 retail price begins.",
    source: "reserve",
  });
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          {/* Both notebook mockups are now landscape (same aspect), so a plain
              full-width fill renders them at equal heights with no matting/
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto mb-12 text-center rounded-lg p-5" style={{ backgroundColor: "hsl(var(--eden-bark))" }}>
            ...
            <p className="font-body text-sm text-white leading-relaxed">
              Preorders are open now. The first <strong>500 kits</strong> sell at the Founders price of <strong>$249</strong>. After the 500th kit, the price moves automatically to the <strong>$349</strong> retail price.
            </p>
          </div>
