...
-- 6. founder_orders v3: same contract as 20260719210000 (which added ord.order_number),
-- plus the shipping fields the fulfillment queue renders. NOTE the file was renumbered
-- from 20260702180000: it MUST sort after 20260719210000, or replaying migrations from
-- scratch would apply this older-dated file last and silently drop order_number.
