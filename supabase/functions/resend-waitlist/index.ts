...
<tr><td style="font-family:Georgia,serif;font-size:11px;color:#1C3A2E;text-align:center;padding-top:8px;">Rooted in Faith Ventures LLC &middot; PO Box 3262, Clarksville, TN 37042</td></tr>
...
function buildHomeschoolEmail(firstName: string): { subject: string; html: string } {
  ...
  const footer = `
    ...
    <p style="font-family:Georgia,serif;font-size:11px;color:#6B6560;margin:0 0 6px 0;">Rooted in Faith Ventures LLC &middot; PO Box 3262, Clarksville, TN 37042</p>
