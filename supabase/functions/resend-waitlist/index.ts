...
<p style="font-family:Georgia,serif;font-size:16px;line-height:1.8;color:#1C3A2E;margin:0 0 16px 0;">Preorder is <strong>open now</strong>. The first <strong>500 kits</strong> sell at the Founders price: <strong>$249</strong>, before the $349 retail price begins. No code needed. Founders pricing applies automatically while the first 500 kits last.</p>
