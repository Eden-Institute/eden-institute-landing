...
<tr><td style="background:${B.forest};padding:16px 22px;text-align:center;"><div style="color:${B.footer};font-family:Georgia,serif;font-size:11px;line-height:1.6;">The Eden Institute &middot; Rooted in Faith Ventures LLC<br>303 Holly Cir, Unit 3262, Clarksville, TN 37043<br><a href="${unsub}" style="color:${B.gold};text-decoration:underline;">Unsubscribe from these homeschool emails</a></div></td></tr>
</table></td></tr></table></body></html>`;
}
